...
import { Mail, Lock, LogIn, GitHub } from "react-feather";
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-gray-950 via-transparent to-purple-900/20 z-0" />

      {/* Login Card */}
      <div className="w-full max-w-md p-8 bg-gray-900/40 backdrop-blur-xl border border-gray-800 rounded-2xl shadow-2xl z-10 mx-4 transition-all duration-300 hover:shadow-purple-500/10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-purple-600/20 rounded-xl mb-4 border border-purple-500/30">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <Button
            ...
            fullWidth
            loading={isLoading}
            className="h-12 text-lg font-semibold shadow-lg shadow-purple-600/20"
          >
            Sign In
          </Button>
        </form>
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-gray-900 px-2 text-gray-500 font-medium tracking-wider">
                Or continue with
              </span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-gray-400 text-sm">
          ...
          <Link
            to="/register"
            className="text-purple-500 hover:text-purple-400 font-bold transition-colors underline-offset-4 hover:underline"
          >
            Create an account
          </Link>
        </p>
      ...
      {/* Decorative Circles */}
      <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-purple-600/10 blur-[120px] rounded-full z-0" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-blue-600/10 blur-[120px] rounded-full z-0" />
    </div>
  );
};
